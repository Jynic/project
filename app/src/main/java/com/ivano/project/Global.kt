...
object Global {
    ...
    val cards = arrayListOf(
        Card(1,"Rahasia Terkunci di Perpustakaan Kuno", "NebulaNomad", "mengisahkan tentang seorang mahasiswa bernama alex yang secara tidak sengaja menemukan sebuah buku kuno yang misterius di perpustakaan universitasnya", "https://live.staticflickr.com/737/32640476365_906f64ce29_b.jpg","Ini adalah permulaan paragraf pertama","Public", "Sci-Fi & Fantasy"),
        Card(2,"Beli Indomie", "Ivano Zefanya", "Mengisahkan sebuah hari dimana saya membeli sebuah Indomie. Malam itu sangatlah dingin dan saya lapar sangat. Tetapi tidak terdapat Indomie.", "https://live.staticflickr.com/737/32640476365_906f64ce29_b.jpg","Ini adalah permulaan paragraf pertama","Restricted", "Horror"),
        Card(3,"Valorant", "SikiLala", "Mengisahkan sebuah permainan online yang dimainkan oleh banyak orang. Banyak orang sangat gemar bermain Valorant. Bahkan ada yang memiliki karir sebagai pro player Valorant.", "https://live.staticflickr.com/737/32640476365_906f64ce29_b.jpg","Ini adalah permulaan paragraf pertama","Public","Action")
